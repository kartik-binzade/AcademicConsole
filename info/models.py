...
test_name = (
    ('Project', 'Project'),
    ('Seminar', 'Seminar'),
    ('Sessional test 1', 'Sessional test 1'),
    ('Sessional test 2', 'Sessional test 2'),
...
class AssignTime(models.Model):
    ...
    period = models.CharField(
        max_length=50, choices=time_slots, default='10:45 - 11:45')
...
class Attendance(models.Model):
    ...
    date = models.DateField(default='2022-26-03')
...
class Marks(models.Model):
    ...
    name = models.CharField(
        max_length=50, choices=test_name, default='Sessional test 1')
    ...
    if kwargs['created']:
        ...
        for single_date in daterange(start_date, end_date):
            if single_date.isoweekday() == days[instance.day]:
                try:
                    AttendanceClass.objects.get(date=single_date.strftime(
                        "%Y-%m-%d"), assign=instance.assign)
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.marks_set.create(name='Seminar')
                    sc.marks_set.create(name='Sessional test 1')
                    sc.marks_set.create(name='Sessional test 2')
                    sc.marks_set.create(name='Practical Exam')
